...
# 211.194.139.247:8080 , SSL 인증서 부착
if __name__ == "__main__":
    app.run(debug=True, host='192.168.0.5', port=8080, ssl_context=('C:\\vsCode\dream_dream_explan\\server\\ssl\cert.pem', 'C:\\vsCode\dream_dream_explan\\server\\ssl\key.pem'))
